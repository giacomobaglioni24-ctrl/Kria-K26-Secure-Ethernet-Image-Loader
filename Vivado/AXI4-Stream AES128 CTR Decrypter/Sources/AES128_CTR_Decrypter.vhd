...
Generic (
    ...
    -- Round Key
    ROUND_KEY: std_logic_vector(127 downto 0) := x"00112233445566778899AABBCCDDEEFF";
    
    -- Counter Initial Value
    COUNTER_INITIAL_VALUE: std_logic_vector(63 downto 0) := x"0000000000000001"
...
Generic (
    ROUND_KEY: std_logic_vector(127 downto 0) := ROUND_KEY
    );
Port (
...
component Counter
Generic (
    COUNTER_INITIAL_VALUE: std_logic_vector(63 downto 0) := COUNTER_INITIAL_VALUE
);
Port (
